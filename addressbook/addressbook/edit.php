...
?>
  <form name="theform"
    ...
    <label><?php echo ucfmsg("FIRSTNAME") ?>:</label>
    <input type="text" name="firstname" value="<?php echoIfSet($addr, 'firstname'); ?>" size="35"/><br />
    
    <label><?php echo ucfmsg("MIDDLENAME") ?>:</label>
    <input type="text" name="middlename" value="<?php echoIfSet($addr, 'middlename'); ?>" size="15""/><br /><br />

    <label><?php echo ucfmsg("LASTNAME") ?>:</label>
    <input type="text" name="lastname"  value="<?php echoIfSet($addr, 'lastname'); ?>"  size="35""/><br />
    ...
    <label><?php echo ucfmsg("COMPANY") ?>:</label>
    <input type="text" name="company"   value="<?php echoIfSet($addr, 'company'); ?>"   size="35"/><br />
    ...
    <label><?php echo ucfmsg("EMAIL") ?>:</label>
    <input type="text" name="email"     value="<?php echoIfSet($addr, 'email'); ?>" size="35"/><br />
  ...
  <label><?php echo ucfmsg("GROUP") ?>:</label>
        <select name="new_group">
          ...
          <?php
          $sql="SELECT group_id,group_name FROM $groups_from_where ORDER BY lower(group_name) ASC";
          $result_groups = mysql_query($sql);
          $result_gropup_snumber = mysql_numrows($result_groups);
          
          while ($myrow_group = mysql_fetch_array($result_groups))
          {
            echo "<option value='".$myrow_group["group_id"]."'>".$myrow_group["group_name"]."</option>\n";
          }
        ?>
        </select><br />
    <?php } ?>
